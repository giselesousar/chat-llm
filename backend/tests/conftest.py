...
from app.api.deps import get_chat_orchestrator, get_current_user, get_db
...
def client(
    ...
    def override_orchestrator() -> ChatOrchestratorService:
        gateway = InferenceGateway(fake_llm)
        return ChatOrchestratorService(db_session, gateway)
